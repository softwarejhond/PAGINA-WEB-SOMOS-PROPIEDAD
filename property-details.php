        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="bg-white property-body border-bottom border-left border-right">
              ...
              <div class="row mb-5">
                ...
                <div class="col-md-6 col-lg-4 text-center border-bottom border-top py-3">
                  <span class="d-inline-block text-black mb-0 caption-text">Precio/&nbsp;m&sup2;</span>
          ...
          <div class="col-lg-4">
            ...
            <div class="bg-white widget border rounded">
              ...
              <h3 class="h4 text-black widget-title mb-3">Contacta un Asesor</h3>
            ...
            <div class="bg-white widget border rounded">
              <h3 class="h4 text-black widget-title mb-3">Parrafo</h3>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="property-entry h-100">
              <a href="property-details.php" class="property-thumbnail">
                <div class="offer-type-wrap">
                  <span class="offer-type bg-info">Alquilar</span>
                </div>
