    ...
    <div class="site-blocks-cover overlay" style="background-image: url(https://adminweb.somospropiedad.com/admin/img/carousel/<?php echo htmlspecialchars($row['url_image']); ?>);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
            <div class="row align-items-center justify-content-center text-center">
                <div class="col-md-10">
                    <span class="d-inline-block bg-<?php echo $row['texto_boton'] === 'Para Alquilar' ? 'success' : 'danger'; ?> text-white px-3 mb-3 property-offer-type rounded">
                        <?php echo htmlspecialchars($row['offer_type']); ?>
                    </span>
                    <h1 class="mb-2"><?php echo htmlspecialchars($row['title']); ?></h1>
                    <p class="mb-5"><strong class="h2 font-weight-bold">$<?php echo number_format($row['price'], 2); ?></strong></p>
